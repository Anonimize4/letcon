...
// import labRoutes from './v1/lab.routes' // Temporarily disabled due to TypeScript errors
...
// router.use('/labs', labRoutes) // Temporarily disabled due to TypeScript errors
